...
//Event 03
lch_event03_marker = L.marker([318.62796, 5809.128106], {icon:lch_event_icon}).addTo(lch_events_group);
...
//Event 05
lch_event05_marker = L.marker([1899.243673, 4821.054034], {icon:lch_event_icon}).addTo(lch_events_group);
...
//Event 13
lch_event13_marker = L.marker([1413.098598, 4721.449548], {icon:lch_event_icon}).addTo(lch_events_group);
...
lch_photo_ops03_marker = L.marker([782.807596, 5811.625], {icon:photo_op_icon}).addTo(lch_photo_ops_group);
...
lch_photo_ops05_marker = L.marker([1017.191251, 5877.118012], {icon:photo_op_icon}).addTo(lch_photo_ops_group);
