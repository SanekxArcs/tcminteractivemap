...
const BOUNDS = [[0, 0], [3579, 6707]];
const EXPANDED_BOUNDS = [[-3000, -4000], [6579, 10707]];
...
export default function MapView({
  ...
  return (
    <MapContainer
      ...
      zoomControl={false}
      bounds={BOUNDS}
      style={{ height: '100%', width: '100%', position: 'absolute', background: 'rgb(70,70,70)' }}
    >
      <MapSetup />
      <ImageOverlay url="/img/oahu_maui.avif" bounds={BOUNDS} />
      ...
      <MiscLayer miscData={miscData} rivalsData={rivalsData} filters={filters} />
